...
// MODIFIED BY:  Mike Ciaraldi to include Doxygen header comments 2017/09/05
// IMPLEMENTS: Toolkit of integer array functions (see intarray.h)
//
// STUDENT: Isaiah Fleischer
// DATE: 01/23/2018
 ...
 * @return Index of the element with the numerically largest value;
 *           in case of a tie, returns the smaller index.
 */
